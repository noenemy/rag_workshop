...
9. **Create** 를 클릭합니다. 다음과 같이 애플리케이션이 생성된 것을 확인할 수 있습니다.
...
2. **Web experience settings**에 **Deployed URL** 값을 확인합니다.
이 URL을 이용해서 Amazon Q Business 앱에 접속할 수 있으며 채팅을 시작할 수 있습니다.

![alt text](images/q3-01.png)

3. **Deployed URL** 을 클릭합니다.

4. 로그인 창에서 앞서 2.2에서 생성한 사용자 이름과 비밀번호를 입력해서 로그인합니다.
<img src="images/q3-02.png" width="350px">
